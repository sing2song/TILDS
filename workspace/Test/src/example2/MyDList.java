...
public class MyDList {
	...
	public MyDList(MyDList list1, MyDList list2) {
		DNode list1Node = list1.tail;
		DNode list2Node = list2.getHead();
		
		list1Node.next=list2Node.prev;
		list2Node.prev=list1Node;
